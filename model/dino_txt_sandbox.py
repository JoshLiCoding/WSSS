...
def download_image() -> Image.Image:
    return Image.open('/u501/j234li/wsss/VOCdevkit/VOC2012/JPEGImages/2011_001382.jpg').convert("RGB") # 2011_003276.jpg, 2010_005022.jpg
...
if __name__ == "__main__":
    # main()
    tags = np.load('/u501/j234li/wsss/pseudolabels_2/class_indices_700.npy') # 700
    pseudolabels = np.load('/u501/j234li/wsss/pseudolabels_2/pseudolabels_700.npy') # 700
    ...
    pseudolabels = pseudolabels / 0.05
    ...
    for i in range(pseudolabels_normalized.shape[2]):
        ...
        plt.figure(figsize=(6,4));  plt.hist(pseudolabels_normalized[:,:,i].flatten(), bins=100); plt.title(f"{class_name} probabilities")
        plt.tight_layout(pad=0); plt.savefig(OUTPUT_DIR/f"dino_txt_pseudolabels_{class_name.replace('/', '_')}_probabilities.png", dpi=300); plt.close()
